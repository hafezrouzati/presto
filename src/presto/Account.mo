...
module {
  ...
  public func defaultSubaccount() : Subacc {
    Blob.fromArrayMut(Array.init(32, 0 : Nat8))
    //Array.init(32, 0 : Nat8);   
  };

  public func accountIdentifier(principal: Principal, subaccount: Subacc) : AccountIdentifier {
